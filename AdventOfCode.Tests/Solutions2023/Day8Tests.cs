...
public class Day8Tests
{
    ...
    {
        var input = Helper.ReadInputLines("Day8Input1.txt", overrideFolderNameByDay: true);
    ...
    {
        var input = Helper.ReadInputLines("Day8Input2.txt", overrideFolderNameByDay: true);
